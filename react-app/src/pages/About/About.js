    ...
    return (
      <div>
        ...
        <ul>
            ...
            <li>Alessio Caciagli (<a href="www.linkedin.com/in/alessio-caciagli-65a55160">LinkedIn</a>)<p>Extension and improvement of the WolframMathematica script. First incorporation of the script in Python. Manager of the team during HackingCovid.</p></li>
            ...
            <li>Cristina Hernández-PisandoColores (<a href="https://www.instagram.com/pisandocolores/">Instagram</a>). <p>Craftwomen of jewellery and macramé at Pisando Colores (Tenerife). Checked the venting stand size and provided in-situ information about the number of itinerant vendors. She will deliver this app around the local authorities in Tenerife for its implementation.</p></li>
            <li>Maite Giordano-MaiteDePapel(<a href="https://www.instagram.com/maitedepapel/">Instagram</a>). <p>Craftswoman of paper and binding. Happydelalaif. Provided ground-view information before HackingCovid. She will deliver this app around the local authorities in Tenerife for its implementation.</p></li>
        </ul>
        <h2>Source code</h2>
